...
$(function(){function e(){$(".site_header").css("height",$(window).height())}function i(){$(".carousel_mini_price_item").each(function(){var e=$(this),i=e.find(".carousel_mini_price_content").outerHeight();e.find(".carousel_mini_price_image").css("min-height",i)})}function s(){$(".carousel_mini_price-LIST").equalHeights()}e(),$(window).resize(function(){e()}),$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.svg" alt="АвтоНаСто">'}}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel_mini_price").on("initialized.owl.carousel",function(){setTimeout(function(){i()},100)}),$(".carousel_mini_price").owlCarousel({loop:!0,nav:!0,dots:!1,smartSpeed:700,navText:['<i class="fa fa-caret-square-o-left"></i>','<i class="fa fa-caret-square-o-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:2},1200:{items:3}}}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,autoHeight:!0}),$(".partners").owlCarousel({nav:!0,loop:!0,dots:!1,items:4,smartSpeed:700,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),i(),$(".carousel_mini_price_composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("select").selectize(),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClaass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$("select option[value=1]").hide(),s(),window.onresize=function(){s()},$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow`")});